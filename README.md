...
```bash
pkg install curl -y && bash <(curl -s [https://raw.githubusercontent.com/YourUsername/TermoOS/main/install.sh](https://raw.githubusercontent.com/YourUsername/TermoOS/main/install.sh))
